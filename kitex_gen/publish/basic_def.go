...
type User struct {
	...
	FillowerCount *int64 `thrift:"fillower_count,4,optional" frugal:"4,optional,i64" json:"fillower_count,omitempty"`
...
var User_FillowerCount_DEFAULT int64

func (p *User) GetFillowerCount() (v int64) {
	if !p.IsSetFillowerCount() {
		return User_FillowerCount_DEFAULT
	}
	return *p.FillowerCount
}
...
func (p *User) SetFillowerCount(val *int64) {
	p.FillowerCount = val
}
...
func (p *User) IsSetFillowerCount() bool {
	return p.FillowerCount != nil
}
...
func (p *User) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetFillowerCount() {
		if err = oprot.WriteFieldBegin("fillower_count", thrift.I64, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI64(*p.FillowerCount); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *User) DeepEqual(ano *User) bool {
	...
	if !p.Field4DeepEqual(ano.FillowerCount) {
		return false
	}
...
func (p *User) Field4DeepEqual(src *int64) bool {
	...
	if p.FillowerCount == src {
		return true
	} else if p.FillowerCount == nil || src == nil {
		return false
	}
	if *p.FillowerCount != *src {
		return false
