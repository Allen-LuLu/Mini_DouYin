...
func (p *User) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	...
	if p.IsSetFillowerCount() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "fillower_count", thrift.I64, 4)
		offset += bthrift.Binary.WriteI64(buf[offset:], *p.FillowerCount)
...
func (p *User) field4Length() int {
	l := 0
	if p.IsSetFillowerCount() {
		l += bthrift.Binary.FieldBeginLength("fillower_count", thrift.I64, 4)
		l += bthrift.Binary.I64Length(*p.FillowerCount)
